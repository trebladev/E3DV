...
int main(void) {
  ...
  bool success = initTracking("../../../ORB_SLAM2/Extrinsics.xml");
  Mat K = getCameraMatrix();

  // Create SLAM system. It initializes all system threads and gets ready to
  // process frames.
  ORB_SLAM2::System SLAM("../../../ORB_SLAM2/Vocabulary/ORBvoc.bin",
                         "../../../ORB_SLAM2/MonocularCam.yaml",
  ...
  do {
    ...
    glfwPollEvents();
    if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS) slamMode = true;
